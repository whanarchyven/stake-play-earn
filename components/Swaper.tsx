...
const Swaper = () => {
    ...
    return (
        <div className={'w-full h-full relative rounded-[2vw]'}>
            ...
            <div className={'w-[93%] h-[78%] rounded-[2vw] hidden sm:inline-block sm:absolute mx-[4%] my-[3%] top-0 left-0'}>
            ...
            <div className={'w-[93%] h-[78%] rounded-[2vw] p-[1.5vw] relative mx-[4%] my-[3%] top-0 left-0'}>
                <div className={'w-full h-[8vh] sm:h-[8vw] rounded-[1.5vh] sm:rounded-[1.5vw] mt-[2%] swiper-tab'}>
                    <div className={'align-top w-[60%] inline-block h-full'}>
                        <p className={'text-white px-[8%] mt-[4%] text-[1.5vh] sm:text-[1.4vw] font-gilroy font-light'}>
                            From
                        </p>
                        <p className={'text-white px-[8%] text-[2.5vh] sm:text-[2.5vw] font-gilroy font-bold'}>
                            -
                        </p>
                    </div>
                    <div className={'align-top w-[40%] inline-block h-full'}>
                        <p className={'text-white px-[8%] h-[30%] mt-[4%] text-[1.5vh] sm:text-[1.4vw] font-gilroy font-light'}>
                            Balance: -
                        </p>
                ...
                <div className={'w-full mt-[3%] relative h-[2.2vh] sm:h-[2vw]'}>
                    <Image src={'/images/account/swiper_arrow.svg'} layout={'fill'}></Image>
                </div>
                <div className={'w-full h-[8vh] rounded-[1.5vh] sm:h-[8vw] sm:rounded-[1.5vw] mt-[2%] swiper-tab'}>
                    <div className={'align-top w-[60%] inline-block h-full'}>
                        <p className={'text-white px-[8%] mt-[4%] text-[1.4vh]  sm:text-[1.4vw] font-gilroy font-light'}>
                            To (estimated)
                        </p>
                        <p className={'text-white px-[8%]  text-[2.5vh]  sm:text-[2.5vw] font-gilroy font-bold'}>
                            -
                    ...
                    <div className={'align-top w-[40%] inline-block h-full'}>
                        <p className={'text-white px-[8%] h-[30%] mt-[4%] text-[1.4vh] sm:text-[1.4vw] font-gilroy font-light'}>
                            Balance: -
                        </p>
                        <div className={'w-full h-[60%]'}>
                            <div className={'w-[30%]  align-top h-full inline-block'}>
                ...
                <div className={'w-full mt-[6%] sm:mt-[2%] relative swiper-price-tab rounded-[1vh] h-[3vh] sm:rounded-[1vw] sm:h-[3vw]'}>
                    <p className={'w-[20%] align-top text-white pl-[4%] inline-block leading-[210%] text-[1.4vh] sm:text-[1.4vw] font-gilroy font-light'}>Price:</p>
                ...
                <div className={'w-full mt-[5%] relative h-[2.3vh] sm:h-[2.3vw]'}>
                    <Image src={'/images/account/swiper_etaps.svg'} layout={'fill'}></Image>
                </div>
            </div>
            <div className={'w-[86%] mx-[7%] mt-[4%] bottom-0 relative rounded-[1vh] h-[2.5vh] sm:rounded-[1vw] sm:h-[2.5vw]'}>
                <p className={'sm:w-[38%] align-middle text-white pl-[4%] inline-block leading-[210%] text-[1.5vh] sm:text-[1.4vw] font-gilroy font-light'}>Minimum recieved:</p>
                <div className={'w-[3%] ml-[2%] align-middle inline-block h-full relative'}>
                    <Image src={'/images/account/swiper_question.svg'} layout={'fill'}></Image>
                </div>
                <p className={'w-[57%] align-middle text-right inline-block text-white pr-[4%] leading-[210%] text-[1.4vh] sm:text-[1.4vw] font-gilroy font-light'}></p>
            </div>
            <div className={'sm:w-[86%] mx-[7%] bottom-0 relative rounded-[1vh] h-[2.5vh] sm:rounded-[1vw] sm:h-[2.5vw]'}>
                <p className={'sm:w-[28%] align-middle text-white pl-[4%] inline-block leading-[210%] text-[1.4vh] sm:text-[1.4vw] font-gilroy font-light'}>Price Impact</p>
                <div className={'w-[3%] ml-[2%] align-middle inline-block h-full relative'}>
                    <Image src={'/images/account/swiper_question.svg'} layout={'fill'}></Image>
                </div>
            ...
            <div className={'sm:w-[86%] mx-[7%] bottom-0 relative rounded-[1vh] h-[2.5vh] sm:rounded-[1vw] sm:h-[2.5vw]'}>
                <p className={'sm:w-[43%] align-middle text-white pl-[4%] inline-block leading-[210%] text-[1.4vh] sm:text-[1.4vw] font-gilroy font-light'}>Liquidity Provider Fee</p>
                <div className={'w-[3%] ml-[2%] align-middle inline-block h-full relative'}>
                    <Image src={'/images/account/swiper_question.svg'} layout={'fill'}></Image>
                </div>
