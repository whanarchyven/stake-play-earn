    ...
    return (
        <div className={'w-full h-full relative rounded-[2vw]'}>
            ...
            <div className={'w-[86%] mx-[7%] mt-[4%] bottom-0 relative rounded-[1vw] h-[2.5vw]'}>
                ...
                <p className={'w-[57%] align-middle text-right inline-block text-white pr-[4%] leading-[210%] text-[1.4vw] font-gilroy font-light'}>472 USDC</p>
            </div>
            <div className={'w-[86%] mx-[7%] bottom-0 relative rounded-[1vw] h-[2.5vw]'}>
                ...
                <p className={'w-[67%] align-middle text-right inline-block text-white pr-[4%] leading-[210%] text-[1.4vw] font-gilroy font-light'}>0.89%</p>
            </div>
            <div className={'w-[86%] mx-[7%] bottom-0 relative rounded-[1vw] h-[2.5vw]'}>
                ...
                <p className={'w-[52%] align-middle text-right inline-block text-white pr-[4%] leading-[210%] text-[1.4vw] font-gilroy font-light'}>0.1107 GNFT</p>
            </div>
        </div>
    );
};
